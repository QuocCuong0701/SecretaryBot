...
public class CommonConstant {
    ...
    public static final List<String> ADMINS = List.of("GroupAnonymousBot", "cuongpq_0701", "quoccuong_0701", "Thuthao_PM", "damvietanh", "quoccuong_779");
